        ...
        <div style="font-size: 13px; margin: 10px 5px;">
            <table class="table_a" border="1" width="100%">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><a href="/exam1/index.php/Admin/Type/xiugai/id/<?php echo ($vo["typeid"]); ?>/typename/<?php echo ($vo["typename"]); ?>">修改</a></td>
                        <td><a href="/exam1/index.php/Admin/Type/shanchu/id/<?php echo ($vo["typeid"]); ?>" onclick="return confirm('你确定要删除这个栏目吗?');">删除</a></td>
